...
#define SX1262_SPI_NSS_PORT_RCC  RCC_AHB1Periph_GPIOA


//SX1262_SPI_SCLK;  //SPI串行时钟 ,SPI_SCK------>PA5
#define SX1262_SPI_SCK_PIN   GPIO_Pin_5
#define SX1262_SPI_SCK_PORT  GPIOA
#define SX1262_SPI_SCK_PORT_RCC  RCC_AHB1Periph_GPIOA

//SX1262_SPI_MOSI ;  //SPI串行数据  SPI_MOSI------>PA7
#define SX1262_SPI_MOSI_PIN   GPIO_Pin_7
#define SX1262_SPI_MOSI_PORT  GPIOA
#define SX1262_SPI_MOSI_PORT_RCC  RCC_AHB1Periph_GPIOA

//SX1262_SPI_MISO ;  //SPI串行数据  SPI_MISO------>PA6
#define SX1262_SPI_MISO_PIN   GPIO_Pin_6
#define SX1262_SPI_MISO_PORT  GPIOA
#define SX1262_SPI_MISO_PORT_RCC  RCC_AHB1Periph_GPIOA

//SX1262_RF_NRESET ;  //RF模块复位 RF_NRESET------>PA1
#define SX1262_RF_NRST_PIN   GPIO_Pin_1
#define SX1262_RF_NRST_PORT  GPIOA
#define SX1262_RF_NRST_PORT_RCC  RCC_AHB1Periph_GPIOA

//SX1262_RF_BUSY ;  //RF模块忙   RF_BUSY------>PB0
#define SX1262_RF_BUSY_PIN   GPIO_Pin_0
#define SX1262_RF_BUSY_PORT  GPIOB
#define SX1262_RF_BUSY_PORT_RCC  RCC_AHB1Periph_GPIOB

//SX1262_RF_DIO1 ;  //RF模块DIO1，中断管脚  RF_IRQ------>PC5
#define SX1262_RF_IRQ_PIN   GPIO_Pin_5
#define SX1262_RF_IRQ_PORT  GPIOC
#define SX1262_RF_IRQ_PORT_RCC  RCC_AHB1Periph_GPIOC
